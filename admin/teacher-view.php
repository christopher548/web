...
<div class="container mt-5">
  ...
  <img src="../teacher-<?php echo $teacher['gender']; ?>.png" class="card-img-top" alt="...">
  <div class="card-body">
  ...
  </ul> <li class="list-group-item">Employee Number: <?php echo $teacher['employee_number']; ?></li>
  <li class="list-group-item">Address: <?php echo $teacher['address']; ?></li>
  <li class="list-group-item">Date_of_birth: <?php echo $teacher['date_of_birth']; ?></li>
  ...
  <li class="list-group-item">Email Address: <?php echo $teacher['email_address']; ?></li>
  <li class="list-group-item">Gender: <?php echo $teacher['gender']; ?></li>
  <li class="list-group-item">Date of joined: <?php echo $teacher['date_of_joined']; ?></li>
