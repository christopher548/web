...
<head>
    ...
    <title>Admin - Editar Estudiante</title>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form method="post"
           ...
           <h3>Editar Informacion de Estudiante</h3><hr>
        ...
        <br><hr>
            ...
            <div class="mb-3">
            <label class="form-label">Numero del Tutor</label>
            <input type="text" 
            class="form-control"
...
<div class="mb-3">
  ...
  <script>
    ...
    function makePass(length){
        var result          = '';
        var characters      = 'ABCDEFGHIJKLMNOPQRSTUVWXYZacbdefghijklmnopqrstuvwxyz0123456789';
